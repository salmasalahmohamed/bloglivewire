    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-8">
                <div class="card">
                    <div class="card-body">
                        <img src="{{ asset('photos/' .$post_data->photo) }}"  alt="" class="card-img-top">
                        <div class="row my-2">
                            <div class="col-xl-6">
                        ...
                        <h2 class="text-primary">{{$post_data->title}}</h2>
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body pb-0">
                        <h5 class="card-title">More posts from {{$post->user->name}}</h5>
